...
CREATE TABLE GEFDATABASE.Room_Classes(CODE_ROOM VARCHAR(10) NOT NULL,
CODE_STUDENTS_CLASS INTEGER NOT NULL,
CODE_COURSE VARCHAR(5) NOT NULL,
PRIMARY KEY (CODE_ROOM, CODE_STUDENTS_CLASS, CODE_COURSE),
FOREIGN KEY(CODE_ROOM) REFERENCES GEFDATABASE.Room, 
FOREIGN KEY(CODE_COURSE) REFERENCES GEFDATABASE.Course,
FOREIGN KEY(CODE_STUDENTS_CLASS, CODE_COURSE) REFERENCES GEFDATABASE.Students_Class);